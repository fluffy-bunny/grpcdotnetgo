...
func RegisterGreeter2HandlerServer(ctx context.Context, mux *runtime.ServeMux, server Greeter2Server) error {
	...
	mux.Handle("POST", pattern_Greeter2_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/helloworld.Greeter2/SayHello", runtime.WithHTTPPathPattern("/v2/example/echo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterGreeter2HandlerClient(ctx context.Context, mux *runtime.ServeMux, client Greeter2Client) error {
	...
	mux.Handle("POST", pattern_Greeter2_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/helloworld.Greeter2/SayHello", runtime.WithHTTPPathPattern("/v2/example/echo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
