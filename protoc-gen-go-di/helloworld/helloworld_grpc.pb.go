...
const (
	Greeter2_SayHello_FullMethodName = "/helloworld.Greeter2/SayHello"
)
...
const (
	EdgeControlService_WriteProps_FullMethodName = "/helloworld.EdgeControlService/WriteProps"
)
...
func (c *edgeControlServiceClient) WriteProps(ctx context.Context, in *WritePropsRequest, opts ...grpc.CallOption) (EdgeControlService_WritePropsClient, error) {
	stream, err := c.cc.NewStream(ctx, &EdgeControlService_ServiceDesc.Streams[0], EdgeControlService_WriteProps_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
